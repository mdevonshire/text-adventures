...
def name_confirm():
	...
	if name_yesno == "YES":
		...
		print "Invalid Response. Remember, type everything in capitals" 
		name_confirm()
# Name
#-----------------------------------------
def pick_class():
	...
	if class_ == "KNIGHT":
		...
		Fork = True
		Stealth = True
		print "You are now a hobo, all you have is a fork."
		print "You also have stealth because you have learnt to hide from the people you owe money."
		shop()
...
def shop():
	...
	if Fork == True:
		print "Since you are a hobo, the shopkeeper kicks you out of the shop."
		hobo_item()
	else:
...
def hobo_item():
	print "-----------------------------"
	print "On the way out of the store you see a piece of STRING and a COIN"
	hobo_choose()
def hobo_choose():
	global String
	global Coin
	global no_count
	no_count = 0
	print "Do you take the STRING, COIN or NOTHING?"
	choice = raw_input()
	if choice == "STRING":
		String = True
		...
		Coin = Coin + 1
		print "You now have %s coin(s)" % (Coin)
		rumour2()
	elif choice == "NOTHING":
		print "You ignore the objects and go on your way, you may be a hobo but your not going to be a scab"
		rumour()
	else:
		print "Invalid Response"
		hobo_choose()
...
def rumour2():
	...
	if look_confirm == "NO":
		...
		if no_count == 2:
			...
			print "Well, you have no sense of adventure at all, do you."
			print "You go and crawl into a hole and die there"
			print "No one remembers you because you where so insignificant"
...
def cave_room_1d2():
	...
	if Dagger > 0:
		...
		cave_room_1d3()
	elif Dagger == 0 and Fork == True:
		print "You are now close enough to strike the troll with your fork"
		print "Or you could try to sneak past the sleeping troll"
		cave_room_1d4()
	else:
		print "Error"
...
def game_over():
	...
	if play_again == "YES" or "Y":
		...
		print "%s gave up with a score or %s" % (name, score)
def credits():
	print "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
